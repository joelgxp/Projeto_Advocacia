...
@section('title', 'Novo Processo - Administrador')
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Cadastrar Novo Processo</h5>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('advogado_id') is-invalid @enderror" 
                        ...
                        @foreach($advogados as $advogado)
                            <option value="{{ $advogado->id }}" {{ old('advogado_id') == $advogado->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('vara_id') is-invalid @enderror" 
                        ...
                        @foreach($varas as $vara)
                            <option value="{{ $vara->id }}" {{ old('vara_id') == $vara->id ? 'selected' : '' }}>
