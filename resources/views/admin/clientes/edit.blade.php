            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('tipo_pessoa') is-invalid @enderror" 
                        ...
                        <option value="PF" {{ old('tipo_pessoa', $cliente->tipo_pessoa) == 'PF' ? 'selected' : '' }}>Pessoa Física</option>
                        <option value="PJ" {{ old('tipo_pessoa', $cliente->tipo_pessoa) == 'PJ' ? 'selected' : '' }}>Pessoa Jurídica</option>
                    </select>
                    @error('tipo_pessoa')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
