                ...
                <form action="{{ route('admin.clientes.update', $cliente) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nome" class="form-control form-control-modern" value="{{ $cliente->nome }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label-modern">CPF/CNPJ *</label>
                            <input type="text" name="cpf_cnpj" class="form-control form-control-modern" value="{{ $cliente->cpf_cnpj }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" name="email" class="form-control form-control-modern" value="{{ $cliente->email }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label-modern">Telefone</label>
                            <input type="text" name="telefone" class="form-control form-control-modern" value="{{ $cliente->telefone }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label-modern">Celular</label>
                            <input type="text" name="celular" class="form-control form-control-modern" value="{{ $cliente->celular }}">
                        </div>
                    </div>
