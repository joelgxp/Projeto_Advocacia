...
// 7. Verificar configuração do servidor (se possível)
...
if (isset($_SERVER['DOCUMENT_ROOT'])) {
    ...
    if ($_SERVER['DOCUMENT_ROOT'] !== $rootDir . '/public' && $_SERVER['DOCUMENT_ROOT'] !== $rootDir) {
        echo "   ⚠️  DocumentRoot não aponta para public/\n";
        echo "   💡 DocumentRoot deve ser: $rootDir/public\n";
