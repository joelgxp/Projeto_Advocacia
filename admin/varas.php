...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-info">Nova Vara</a>
	...
	<div class="col-md-6 col-sm-12">
		...
		<div class="float-right mr-4">
			<form id="frm" class="form-inline my-2 my-lg-0" method="post">
				...
				<input class="form-control form-control-sm mr-sm-2" type="search" placeholder="Vara" aria-label="Search" name="txtbuscar" id="txtbuscar">
