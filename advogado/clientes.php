				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<textarea class="form-control"  name="obs" maxlength="350"><?php echo @$endereco ?></textarea>
						</div>
					</div>
				</div>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-4 col-sm-12">
						<label for="exampleFormControlInput1">Física / Jurídica (Parte Contrária)</label>
							<select class="form-control" id="pessoa_processo" name="tipo_pessoa">
						...
						<div class="form-group">
							<label for="exampleFormControlInput1">CPF (Parte Contrária)</label>
					...
					<div class="col-md-4 col-sm-12" id="divcnpjprocessado">
						<div class="form-group">
							<label for="exampleFormControlInput1">CNPJ (Parte Contrária)</label>
					...
					<div class="col-md-4 col-sm-12">
						<div class="form-group">
							<label for="exampleFormControlInput1">Nome (Parte Contrária)</label>
							
							<input type="text" class="form-control" id="nomeprocessado" disabled">
