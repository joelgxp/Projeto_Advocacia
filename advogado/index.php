                ...
                <ul class="rd-navbar-nav">
                 ...
                 <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item1 ?>">Home</a>
                  ...
                  <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item2 ?>">Clientes</a>
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item5 ?>">Processos</a>
                  </li>
                   <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item3 ?>">Agenda</a>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item4 ?>">Parte Contrária</a>
                  </li>
